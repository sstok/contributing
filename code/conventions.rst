...
projects and the internal and third-party libraries. This document describes
coding standards and conventions used to make it more consistent and predictable.
...
project; that happens when a feature implementation cannot be changed
...
relevant classes, methods, properties, ...::
    ...
    /**
     * @deprecated Deprecated since version 1.x, to be removed in 2.x. Use XXX instead.
     */
...
feature will be removed (depending on the criticality of the removal)::
    ...
    @trigger_error(
        'XXX() is deprecated since version 1.x and will be removed in 2.x. Use XXX instead.',
        E_USER_DEPRECATED
    );

.. note::

    The silencing of the error ensures the error is only triggered for
