...
.. code-block:: text
    ...
    .. _`Documentation`: http://example.com/doc

Code Examples
-------------

* The code follows the :doc:`Coding Standards </code/standards>`
...
* When you list a Framework file/directory hierarchy, use ``your-project/`` as the
