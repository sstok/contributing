...
The documentation uses reStructuredText_ as its markup language and
...
familiarize with this format by reading the existing `documentation`_
...
the project, you should precede your description of the change with a
